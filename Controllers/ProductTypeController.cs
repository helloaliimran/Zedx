...
namespace Zedx.Controllers
{
    public class ProductTypeController : Controller
    {
        ...
        public ProductTypeController(ZedxContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductTypeId,name,CreatedById,ModifiedById,CreatedDate,ModifiedDate,Deleted")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductTypeId,name,CreatedById,ModifiedById,CreatedDate,ModifiedDate,Deleted")] ProductType productType)
        {
